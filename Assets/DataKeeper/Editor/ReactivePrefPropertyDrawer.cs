...
namespace DataKeeper.Editor
{
    ...
    public class ReactivePrefPropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.DrawRect(new Rect(position.x, position.y + 1, position.width, _buttonWidth), new Color(0.15f, 0.31f, 0.15f));
            ...
            buttonPosition.x += _buttonWidth + _space;
            GUIContent buttonContent3 = new GUIContent("F", "Fire event. Only play mode.");
